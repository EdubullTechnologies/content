...
Please provide the improved version of the text. Keep the same general structure and length unless specifically asked to expand or shorten."""
    ...
    with canvas_col:
                    ...
                    try {
                        ...
                        if (selectedText && selectedText.trim()) {
                            ...
                            navigator.clipboard.writeText(selectedText).then(() => {
                                ...
                                // Fallback: try to programmatically select and copy
                                ...
                                try {
                                    ...
                                    alert('Text selected! Please paste it in the text area below to proceed.');
                                } catch (err) {
        ...
        st.info("💡 **How to select text**: \n1. **Method 1**: Highlight text in the canvas above by clicking and dragging, then click '✂️ Use Selected Text' button\n2. **Method 2**: Manually copy text from canvas (Ctrl+C/Cmd+C) and paste below\n3. **Method 3**: Use the Advanced Selection Options for precise position-based selection")
