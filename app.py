...
"""
    ...
    try:
        ...
        generation_config = genai.types.GenerationConfig(
            ...
            temperature=0.2,  # Add some creativity to avoid direct copying
        )
...
"""
        ...
        try:
            ...
            if subject_type == "Mathematics" and content_type == "chapter":
                integration_config = genai.types.GenerationConfig(
                    max_output_tokens=131072,  # Doubled for multi-section math chapters
                    temperature=0.2,  # Lower temperature for more coherent integration
                )
            else:
                integration_config = genai.types.GenerationConfig(
                    max_output_tokens=131072,
...
Current user question: {user_prompt}"""
        ...
        generation_config = genai.types.GenerationConfig(
            max_output_tokens=131072,
            temperature=0.2,  # Slightly higher temperature for more conversational responses
        )
